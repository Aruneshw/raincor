...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 h-screen sticky top-0 flex flex-col bg-white dark:bg-[#0B132B] border-r border-slate-200/80 dark:border-white/10 z-40 select-none transition-colors duration-200">
      {/* Brand Header */}
      <div className="p-5 pb-4 border-b border-slate-100 dark:border-white/10 flex items-center gap-3">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "text-slate-600 dark:text-slate-400 hover:text-navy dark:hover:text-white hover:bg-slate-50 dark:hover:bg-white/5"
                  )}
                >
                  ...
                  {item.badge && (
                    <span
                      className={cn(
                        ...
                        item.badge === "Live"
                          ? "bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20"
                          : "bg-purple-100 dark:bg-purple-950/80 text-purple-700 dark:text-purple-400 border border-purple-500/20"
                      )}
                    >
                      {item.badge}
                    </span>
      ...
      {/* Footer Info */}
      <div className="p-4 border-t border-slate-100 dark:border-white/10 bg-slate-50/50 dark:bg-white/[0.02]">
        <div className="text-[11px] font-semibold text-navy dark:text-white">
